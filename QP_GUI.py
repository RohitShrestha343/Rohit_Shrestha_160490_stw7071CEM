...
# GUI build steps
window = Tk()
window.configure(bg='#FC6C85')
window.geometry('1000x750')
label = Label(window, text="KHOJI ENGINE", bg="#FC6C85", fg="white", font="'Arial' 24 bold")
...
inputBar.pack()
inputBar.place(x=60, y=70)
count.place(x=810, y=90)
outcome.place(x=870, y=90)
outputData = scrolledtext.ScrolledText(window, width=110, height=37)
outputData.place(x=50, y=120)
search = Button(window, text='SEARCH', bg="#FFC0CB", fg="#FC6C85", font="'Arial' 10", command=pub_qp_data)
search.place(x=370, y=70)
operator = IntVar()
operator.set(2)
